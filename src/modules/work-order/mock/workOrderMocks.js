...
export const MOCK_WO_TABLE_DATA = [
  ...
  {
    // Deliberately overdue: still open (Ready to Process) with a planned end
    // date before the list page's reference "today" (2026-03-31) — exercises
    // the Planned Date warning icon/tooltip.
    wo: "WO-202603-010",
    ord: "ORD-202603-010",
    targetType: "Product",
    fulfillmentType: "CustomerOrder",
    postedToStock: false,
    product: "Rattan Storage Basket",
    sku: "RTN-BSK-010",
    qty: 40,
    priority: "High",
    pColor: "var(--status-red-primary)",
