      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
        ...
        >
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: "16px" }}>
            ...
            <LabelValue label="Data in File" value={batch.rawRows?.length ?? batch.sourceRowCount ?? batch.totalMaterials} />
            <LabelValue label="Data after Review" value={batch.totalMaterials} />
